<nav class="bg-white dark:bg-gray-800 shadow-sm py-4 px-6 md:px-10 flex justify-between items-center rounded-b-lg">
    ...
    <div class="flex items-center space-x-4">
        @guest('admin')
        <a href="{{ route('login') }}" class="text-gray-600 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition duration-300 ease-in-out hidden sm:block">Iniciar Sesión</a>
