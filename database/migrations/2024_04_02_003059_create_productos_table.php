...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('productos', function (Blueprint $table) {
            ...
            $table->boolean('modo_comision')->nullable()->default(0);
            $table->float('porcentaje_comision',2,2)->nullable()->default(0);
            $table->float('valor_comision',20,2)->nullable()->default(0);
            $table->float('precio_normal',20,2)->default(0);
            $table->float('precio_descuento',20,2)->nullable()->default(0);
            $table->boolean('descuento_activo')->default(0);
            $table->float('precio_minimo',20,2)->default(0);
            $table->float('porcentaje_impuesto',2,1)->nullable()->default(0);
            $table->boolean('disponible')->default(1);
            $table->boolean('tipo')->default('1');
            $table->boolean('preguntar_precio')->nullable()->default(0);
            $table->boolean('notificar_minimo')->nullable()->default(0);
